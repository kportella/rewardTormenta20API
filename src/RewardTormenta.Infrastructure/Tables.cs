...
public static class Tables
{
    ...
    [
        ...
        // Tabela 8-14 — Médios
        new() { Tier = MagicItemTier.Medio, Name = "Anel de telecinese",             Price = 10_500,  MinRoll = 1,   MaxRoll = 4   },
        new() { Tier = MagicItemTier.Medio, Name = "Bola de cristal",                Price = 10_500,  MinRoll = 5,   MaxRoll = 8   },
        new() { Tier = MagicItemTier.Medio, Name = "Caveira maldita",                Price = 10_500,  MinRoll = 9,   MaxRoll = 10  },
        new() { Tier = MagicItemTier.Medio, Name = "Botas aladas",                   Price = 15_000,  MinRoll = 11,  MaxRoll = 14  },
        new() { Tier = MagicItemTier.Medio, Name = "Braceletes de bronze",           Price = 16_500,  MinRoll = 15,  MaxRoll = 18  },
        new() { Tier = MagicItemTier.Medio, Name = "Anel da energia",                Price = 21_000,  MinRoll = 19,  MaxRoll = 24  },
        new() { Tier = MagicItemTier.Medio, Name = "Anel da vitalidade",             Price = 21_000,  MinRoll = 25,  MaxRoll = 30  },
        new() { Tier = MagicItemTier.Medio, Name = "Anel de invisibilidade",         Price = 21_000,  MinRoll = 31,  MaxRoll = 34  },
        new() { Tier = MagicItemTier.Medio, Name = "Braçadeiras do arqueiro",        Price = 21_000,  MinRoll = 35,  MaxRoll = 38  },
        new() { Tier = MagicItemTier.Medio, Name = "Brincos de Marah",               Price = 21_000,  MinRoll = 39,  MaxRoll = 42  },
        new() { Tier = MagicItemTier.Medio, Name = "Faixas do pugilista",            Price = 21_000,  MinRoll = 43,  MaxRoll = 46  },
        new() { Tier = MagicItemTier.Medio, Name = "Manto da aranha",                Price = 21_000,  MinRoll = 47,  MaxRoll = 50  },
        new() { Tier = MagicItemTier.Medio, Name = "Vassoura voadora",               Price = 21_000,  MinRoll = 51,  MaxRoll = 54  },
        new() { Tier = MagicItemTier.Medio, Name = "Símbolo abençoado",              Price = 21_000,  MinRoll = 55,  MaxRoll = 58  },
        new() { Tier = MagicItemTier.Medio, Name = "Amuleto da robustez",            Price = 25_500,  MinRoll = 59,  MaxRoll = 64  },
        new() { Tier = MagicItemTier.Medio, Name = "Botas velozes",                  Price = 25_500,  MinRoll = 65,  MaxRoll = 68  },
        new() { Tier = MagicItemTier.Medio, Name = "Cinta da força do gigante",      Price = 25_500,  MinRoll = 69,  MaxRoll = 74  },
        new() { Tier = MagicItemTier.Medio, Name = "Coroa majestosa",                Price = 25_500,  MinRoll = 75,  MaxRoll = 80  },
        new() { Tier = MagicItemTier.Medio, Name = "Estola da serenidade",           Price = 25_500,  MinRoll = 81,  MaxRoll = 86  },
        new() { Tier = MagicItemTier.Medio, Name = "Manto do morcego",               Price = 25_500,  MinRoll = 87,  MaxRoll = 88  },
        new() { Tier = MagicItemTier.Medio, Name = "Pulseiras da celeridade",        Price = 25_500,  MinRoll = 89,  MaxRoll = 94  },
        new() { Tier = MagicItemTier.Medio, Name = "Tiara da sapiência",             Price = 25_500,  MinRoll = 95,  MaxRoll = 100 },
    ...
    [
        ...
        new() { Tier = TreasureTier.Media, RollExpression = "2d4x10",     AverageValue = 50,      MinRoll = 1,  MaxRoll = 10  },
        new() { Tier = TreasureTier.Media, RollExpression = "4d6x10",     AverageValue = 140,     MinRoll = 11, MaxRoll = 30  },
        new() { Tier = TreasureTier.Media, RollExpression = "1d6x100",    AverageValue = 350,     MinRoll = 31, MaxRoll = 50  },
        new() { Tier = TreasureTier.Media, RollExpression = "2d6x100",    AverageValue = 700,     MinRoll = 51, MaxRoll = 65  },
        new() { Tier = TreasureTier.Media, RollExpression = "2d8x100",    AverageValue = 900,     MinRoll = 66, MaxRoll = 80  },
        new() { Tier = TreasureTier.Media, RollExpression = "4d10x100",   AverageValue = 2_200,   MinRoll = 81, MaxRoll = 90  },
        new() { Tier = TreasureTier.Media, RollExpression = "6d12x100",   AverageValue = 3_900,   MinRoll = 91, MaxRoll = 95  },
        new() { Tier = TreasureTier.Media, RollExpression = "2d10x1.000", AverageValue = 11_000,  MinRoll = 96, MaxRoll = 99  },
        new() { Tier = TreasureTier.Media, RollExpression = "6d8x1.000",  AverageValue = 27_000,  MinRoll = 100,MaxRoll = 100 },
